...
public class ShopLoginUtil {
    ...
    public ShopLoginUtil(RedissonClient redisClient) {
        ShopLoginUtil.redisClient = redisClient;
    }
    ...
    public static LoginShopUserRedisVo getLoginShopUserRedisVo() {
        ...
        RBucket<LoginShopUserRedisVo> bucket = redisClient.getBucket(CommonRedisKey.getRedisKey(CommonRedisKey.SHOP_LOGIN_USER, username));
        return bucket.get();
    }
