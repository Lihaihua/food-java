...
public class RegionCache {
    ...
    public void clearCache(){
        redisClient.getBucket(CommonRedisKey.getRedisKey(CommonRedisKey.REGION_DATA)).delete();
    }

    public Map<String,Object> getCache(){
        RBucket<Map<String, Object>> bucket = redisClient.getBucket(CommonRedisKey.getRedisKey(CommonRedisKey.REGION_DATA));
        Map<String, Object> object = bucket.get();
        if(object != null){
            return object;
        }
        // 所有地区
