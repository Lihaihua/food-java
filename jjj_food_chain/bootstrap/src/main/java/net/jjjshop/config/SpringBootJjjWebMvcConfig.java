...
import net.jjjshop.framework.interceptor.UploadRateLimitInterceptor;
...
public class SpringBootJjjWebMvcConfig implements WebMvcConfigurer {
     ...
     */
    @Bean
    public UploadRateLimitInterceptor uploadRateLimitInterceptor() {
        return new UploadRateLimitInterceptor();
    }
