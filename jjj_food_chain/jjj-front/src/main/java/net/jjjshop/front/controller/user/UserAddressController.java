...
public class UserAddressController extends BaseController {
    ...
    public ApiResult<Map<String, Object>> detail(Integer addressId) {
        ...
        result.put("detail", userAddressService.detail(addressId, user.getUserId()));
    ...
    public ApiResult<String> edit(@Validated @RequestBody UserAddressParam userAddressParam) {
        User user = this.getUser(true);
        if(userAddressService.edit(userAddressParam, user.getUserId())) {
    ...
    public ApiResult setDefault(Integer addressId) {
        User user = this.getUser(true);
        return ApiResult.ok(userAddressService.defaultAddress(addressId, user));
    }
