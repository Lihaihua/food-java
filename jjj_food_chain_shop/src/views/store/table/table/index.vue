<template>
	<div class="product">
					...
					<el-table-column fixed="right" label="操作" width="190">
						<template #default="scope">
							...
							<el-button @click="editClick(scope.row)" type="text" size="small"
								v-auth="'/store/table/table/edit'">编辑
							</el-button>
		...
		<!--添加-->
		<Add v-if="open_add" :open_add="open_add" :type="typeList" :areaList="areaList" :addform="categoryModel"
			@closeDialog="closeDialogFunc($event, 'add')">
		</Add>
		<!--修改-->
		<Edit v-if="open_edit" :open_edit="open_edit" :editform="categoryModel" :type="typeList" :areaList="areaList"
